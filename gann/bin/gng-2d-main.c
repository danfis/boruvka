...
int main(int argc, char *argv[])
{
    ...
    gng = gannGNG2New(&ops, &params);
    size = gannGNG2AddInputSignalsFromFile(gng, argv[1]);
    ...
    gannGNG2DumpSVT(gng, stdout, NULL);
...
static int terminate(void *data)
{
    ...
    return gannGNG2NodesLen(p->gng) >= p->max_nodes;
}
...
static void callback(void *data)
{
    ...
    nodes_len = gannGNG2NodesLen(p->gng);
