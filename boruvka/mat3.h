 ...
 */
extern const bor_mat3_t *fer_mat3_identity;

/**
 * Holds zero matrix. Read only variable!
 */
extern const bor_mat3_t *fer_mat3_zero;
 ...
 * Clones given matrix.
 */
_fer_inline bor_mat3_t *ferMat3Clone(const bor_mat3_t *m);

/**
 * Copies matrix from s to d.
 */
_fer_inline void ferMat3Copy(bor_mat3_t *d, const bor_mat3_t *s);


/**
 * Returns element from specified position.
 */
_fer_inline bor_real_t ferMat3Get(const bor_mat3_t *m, size_t row, size_t col);

/**
 * Sets element at specified position.
 */
_fer_inline void ferMat3Set1(bor_mat3_t *m, size_t row, size_t col,
                             bor_real_t val);

/**
 * Sets all elements to val.
 */
_fer_inline void ferMat3SetAll(bor_mat3_t *m, bor_real_t val);

/**
 * Sets whole matrix.
 */
_fer_inline void ferMat3Set(bor_mat3_t *m,
 ...
 * Sets rows of matrix
 */
_fer_inline void ferMat3SetRows(bor_mat3_t *m,
 ...
 *     | 0 0 1 |
 */
_fer_inline void ferMat3SetIdentity(bor_mat3_t *m);

/**
 * Set zero matrix.
 */
_fer_inline void ferMat3SetZero(bor_mat3_t *m);
 ...
 *     | 0 0 1 |
 */
_fer_inline void ferMat3SetScale(bor_mat3_t *m, bor_real_t s);
 ...
 *     | 0 0 s |
 */
_fer_inline void ferMat3SetDiag(bor_mat3_t *m, bor_real_t s);
 ...
 *     | 0 0 1 |
 */
_fer_inline void ferMat3SetTranslate(bor_mat3_t *m, const bor_vec2_t *v);
 ...
 *     |   0       0    1 |
 */
_fer_inline void ferMat3SetRot(bor_mat3_t *m, bor_real_t angle);

/**
 * Set rotation matrix (3D) defined by rotation about x, y, z axis
 * respectively.
 */
_fer_inline void ferMat3SetRot3D(bor_mat3_t *m,
 ...
 *     | 0 0 1 |
 */
_fer_inline void ferMat3TrScale(bor_mat3_t *m, bor_real_t s);
 ...
 *     | 0 0 1 |
 */
_fer_inline void ferMat3Translate(bor_mat3_t *m, const bor_vec2_t *v);
 ...
 *     |   0       0    1 |
 */
_fer_inline void ferMat3Rot(bor_mat3_t *m, bor_real_t angle);
 ...
 * A = B . A
 */
_fer_inline void ferMat3Compose(bor_mat3_t *A, const bor_mat3_t *B);


/**
 * a = a + b
 */
_fer_inline void ferMat3Add(bor_mat3_t *a, const bor_mat3_t *b);

/**
 * d = a + b
 */
_fer_inline void ferMat3Add2(bor_mat3_t *d, const bor_mat3_t *a,
                                            const bor_mat3_t *b);

/**
 * a = a - b
 */
_fer_inline void ferMat3Sub(bor_mat3_t *a, const bor_mat3_t *b);

/**
 * d = a - b
 */
_fer_inline void ferMat3Sub2(bor_mat3_t *d, const bor_mat3_t *a,
                                            const bor_mat3_t *b);

/**
 * d = d * s
 */
_fer_inline void ferMat3Scale(bor_mat3_t *d, bor_real_t s);

/**
 * d = a * s
 */
_fer_inline void ferMat3Scale2(bor_mat3_t *d, const bor_mat3_t *a, bor_real_t s);

/**
 * d = d + c
 */
_fer_inline void ferMat3AddConst(bor_mat3_t *d, bor_real_t c);

/**
 * d = a + c
 */
_fer_inline void ferMat3AddConst2(bor_mat3_t *d, const bor_mat3_t *a, bor_real_t c);

/**
 * d = d - c
 */
_fer_inline void ferMat3SubConst(bor_mat3_t *d, bor_real_t c);

/**
 * d = a - c
 */
_fer_inline void ferMat3SubConst2(bor_mat3_t *d, const bor_mat3_t *a, bor_real_t c);


/**
 * a = a * b
 */
_fer_inline void ferMat3Mul(bor_mat3_t *a, const bor_mat3_t *b);

/**
 * d = a * b
 */
_fer_inline void ferMat3Mul2(bor_mat3_t *d, const bor_mat3_t *a,
                                            const bor_mat3_t *b);

/**
 * a = b * a
 */
_fer_inline void ferMat3MulLeft(bor_mat3_t *a, const bor_mat3_t *b);

/**
 * a = b^t * a
 */
_fer_inline void ferMat3MulLeftTrans(bor_mat3_t *a, const bor_mat3_t *b);

/**
 * d = a^t * b
 */
_fer_inline void ferMat3MulTrans2(bor_mat3_t *d,
                                  const bor_mat3_t *a, const bor_mat3_t *b);

/**
 * Multiplies {a} by matrix defined by three column vectors.
 */
_fer_inline void ferMat3MulColVecs2(bor_mat3_t *d, const bor_mat3_t *a,
 ...
 *     |row3|
 */
_fer_inline void ferMat3MulLeftRowVecs2(bor_mat3_t *d, const bor_mat3_t *a,
                                        const bor_vec3_t *row1,
                                        const bor_vec3_t *row2,
                                        const bor_vec3_t *row3);
 ...
 */
_fer_inline void ferMat3MulComp(bor_mat3_t *a, const bor_mat3_t *b);
_fer_inline void ferMat3MulComp2(bor_mat3_t *d, const bor_mat3_t *a,
                                                const bor_mat3_t *b);

/**
 * Transposes matrix.
 */
_fer_inline void ferMat3Trans(bor_mat3_t *d);
_fer_inline void ferMat3Trans2(bor_mat3_t *d, const bor_mat3_t *a);

/**
 * Returns true if matrix is regular.
 */
_fer_inline int ferMat3Regular(const bor_mat3_t *m);

/**
 * Returns true if matrix is singular.
 */
_fer_inline int ferMat3Singular(const bor_mat3_t *m);

/**
 * Returns determinant of matrix.
 */
_fer_inline bor_real_t ferMat3Det(const bor_mat3_t *m);

/**
 * Inverts matrix.
 * Returns 0 on success, -1 if matrix is singular.
 */
_fer_inline int ferMat3Inv(bor_mat3_t *m);
 ...
 * Returns 0 on success, -1 if matrix is singular.
 */
_fer_inline int ferMat3Inv2(bor_mat3_t *m, const bor_mat3_t *a);
 ...
 * v = m * w
 */
_fer_inline void ferMat3MulVec(bor_vec3_t *v, const bor_mat3_t *m,
                                              const bor_vec3_t *w);
 ...
 * v = m^t * w
 */
_fer_inline void ferMat3MulVecTrans(bor_vec3_t *v, const bor_mat3_t *m,
                                                   const bor_vec3_t *w);
 ...
 * v.y = v.y / v.z
 */
_fer_inline void ferMat3MulVec2(bor_vec2_t *v, const bor_mat3_t *m,
                                               const bor_vec2_t *w);

/**
 * dst = ABS(src)
 */
_fer_inline void ferMat3Abs2(bor_mat3_t *dst, const bor_mat3_t *src);
 ...
 */
_fer_inline bor_real_t ferMat3DotRowCol(const bor_mat3_t *m, size_t r,
                                        const bor_mat3_t *n, size_t c);


_fer_inline void ferMat3CopyCol(bor_vec3_t *col, const bor_mat3_t *m, size_t c);
_fer_inline void ferMat3CopyRow(bor_vec3_t *row, const bor_mat3_t *m, size_t r);

/**
 * Returns dot product of col'th column of matrix m with vector (a, b, c).
 */
_fer_inline bor_real_t ferMat3DotCol(const bor_mat3_t *m, size_t col,
                                     const bor_vec3_t *v);

/**
 * Returns dot product of row'th row of matrix m with vector (a, b, c).
 */
_fer_inline bor_real_t ferMat3DotRow(const bor_mat3_t *m, size_t row,
                                     const bor_vec3_t *v);
...
_fer_inline void ferMat3SetIdentity(bor_mat3_t *m)
{
    ferMat3Set(m, BOR_ONE, BOR_ZERO, BOR_ZERO,
...
_fer_inline void ferMat3SetZero(bor_mat3_t *m)
{
    ferMat3SetAll(m, BOR_ZERO);
}

_fer_inline void ferMat3SetScale(bor_mat3_t *m, bor_real_t s)
{
    ferMat3Set(m, s, BOR_ZERO, BOR_ZERO,
                  BOR_ZERO, s, BOR_ZERO,
                  BOR_ZERO, BOR_ZERO, BOR_ONE);
}
...
_fer_inline void ferMat3SetTranslate(bor_mat3_t *m, const bor_vec2_t *v)
{
    ferMat3Set(m, BOR_ONE, BOR_ZERO, ferVec2X(v),
                  BOR_ZERO, BOR_ONE, ferVec2Y(v),
                  BOR_ZERO, BOR_ZERO, BOR_ONE);
}

_fer_inline void ferMat3SetRot(bor_mat3_t *m, bor_real_t angle)
{
    ferMat3Set(m, BOR_COS(angle), -BOR_SIN(angle), BOR_ZERO,
                                               ...
                                               const bor_vec2_t *_w)
{
    ...
    ferVec3Set(&w, ferVec2X(_w), ferVec2Y(_w), BOR_ONE);
...
_fer_inline bor_real_t ferMat3DotCol(const bor_mat3_t *m, size_t c,
                                     const bor_vec3_t *v)
{
    bor_vec3_t col;
